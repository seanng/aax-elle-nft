...
export const AUTONUMBER = 'Autonumber'
export const FRAME_PHRASE = 'Frame Phrase (English)'
export const FRAME_SENDER = 'Frame Sender (English)'
export const FRAME_RECEIVER = 'Frame Receiver (English)'
